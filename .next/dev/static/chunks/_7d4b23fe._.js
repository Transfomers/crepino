...
"[project]/src/app/data/translations.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const translations = {
    ...
    'complaints.quality': {
        fr: 'Qualité du Produit 🍽️',
        en: 'Product Quality 🍽️',
        ar: 'جودة المنتج 🍽️'
    },
    'complaints.hygiene': {
        fr: 'Hygiène 🧹',
    ...
    'complaints.subtitle': {
        fr: 'Votre avis compte pour nous améliorer',
        en: 'Your feedback matters for our improvement',
        ar: 'رأيك يهمنا لنتمكن من التحسن'
    },
    ...
    'complaints.helpText': {
        fr: 'Un email sera ouvert avec les détails de votre avis pour nous améliorer',
        en: 'An email will be opened with your feedback details for our improvement',
        ar: 'سيتم فتح بريد إلكتروني يحتوي على تفاصيل ملاحظاتك لتحسين خدماتنا'
    },
    // Booking specific
    'booking.anniversary': {
        fr: 'Anniversaire 🎂',
    ...
    'booking.whatsAppNew': {
        fr: '🎉 NOUVELLE RÉSERVATION D\'ÉVÉNEMENT 🎉',
        en: '🎉 NEW EVENT BOOKING 🎉',
        ar: '🎉 حجز فعالية جديد 🎉'
    },
    'booking.clientInfo': {
    ...
    'booking.subtitle': {
        fr: 'Anniversaires, Graduations, Fêtes & Plus',
        en: 'Birthdays, Graduations, Parties & More',
        ar: 'أعياد ميلاد، تخرج، حفلات والمزيد'
    },
    'booking.name': {
        fr: 'Votre nom *',
        en: 'Your name *',
    ...
    'booking.budget': {
        fr: 'Budget estimé (FCFA)',
        en: 'Estimated budget (FCFA)',
        ar: 'الميزانية المقدرة (فرنك أفريقي)'
    },
    'booking.message': {
        fr: 'Demandes spéciales',
        en: 'Special requests',
    ...
    'booking.specialRequestsPlaceholder': {
        fr: 'Décoration, gâteau personnalisé, menu spécial, allergie alimentaires...',
        en: 'Decoration, custom cake, special menu, food allergies...',
        ar: 'ديكور، كعكة مخصصة، قائمة طعام خاصة، حساسية الطعام...'
    },
    'booking.confirmHelp': {
        fr: 'Nous vous contacterons dans les 24h pour confirmer votre réservation',
        en: 'We will contact you within 24h to confirm your reservation',
        ar: 'سنتواصل معك في غضون 24 ساعة لتأكيد حجزك'
    },
    'booking.reserve': {
        fr: 'Reserver',
        en: 'Reserve',
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$data$2f$translations$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/data/translations.ts [app-client] (ecmascript)");
;
...
function LanguageProvider({ children }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "LanguageProvider.useEffect": ()=>{
            ...
            ;
            const savedLang = localStorage.getItem('crepino-language');
            let initialLang = 'fr';
            ...
            }["LanguageProvider.useEffect"], 0);
        }
    }["LanguageProvider.useEffect"], [
        setLanguage
    ]);
    const t = (key)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$data$2f$translations$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getTranslation"])(key, language);
...
_s(LanguageProvider, "Lcb3hJAMUC8zOaYHShEP+1b2WrM=");
_c = LanguageProvider;
...
function CartProvider({ children }) {
    ...
    const [lastAddedProduct, setLastAddedProduct] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
...
_s(CartProvider, "LN84UIh/VrJmLMqlKkrI3Ix8xgs=");
_c = CartProvider;
function useCart() {
    _s1();
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Loader.useEffect": ()=>{
            ...
            const fadeTimer = setTimeout({
                "Loader.useEffect.fadeTimer": ()=>{
                    setFadeOut(true);
                }
            }["Loader.useEffect.fadeTimer"], 2000);
            // Remove loader after fade animation
            const removeTimer = setTimeout({
                "Loader.useEffect.removeTimer": ()=>{
                    setIsLoading(false);
                }
            }["Loader.useEffect.removeTimer"], 2500);
            return ({
                "Loader.useEffect": ()=>{
...
_s(Loader, "Wh8B7hHBgcwrkn2tl8j3xAbr78s=");
_c = Loader;
var _c;
...
//# sourceMappingURL=_7d4b23fe._.js.map